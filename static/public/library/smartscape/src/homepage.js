        ...
        <Row>
            ...
            <Col xs='6'>
                ...
                <h5 className="header">Please select an app to begin</h5>
                  <a href="/grazescape"><Image  className = "shadow-lg app_click image" fluid src="static/public/library/src/images/graze-logo.png" rounded /></a>
                        </Row>

                        <Row>

                  <a href="/smartscape"><Image className = "shadow-lg app_click image" fluid src="static/public/library/src/images/dss_logo.png" rounded /></a>
                        </Row>
             </Col>
             <Col xs='3'>
            </Col>
