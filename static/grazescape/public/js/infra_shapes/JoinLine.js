...
//------------------------------------------------------------------------------
Ext.define('DSS.infra_shapes.JoinLine', {
//------------------------------------------------------------------------------
	extend: 'Ext.Container',
	alias: 'widget.infra_JoinLine',
    alternateClassName: 'DSS.JoininfraShapes',
    singleton: true,	
	...
	initComponent: function() {
		...
		Ext.applyIf(me, {
			items: [{
				...
				html: 'infra Shapes <i class="fas fa-code-branch fa-fw fa-rotate-270 accent-text text-drp-50"></i>',
				height: 35
			},{
				xtype: 'container',
				...
				items: [{
					...
					xtype: 'component',
					cls: 'information light-text text-drp-20',
					html: 'Click one or more adjacent (touching) infras to merge',
				},{
					xtype: 'button',
					cls: 'button-text-pad',
