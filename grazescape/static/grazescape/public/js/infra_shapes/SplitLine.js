...
//------------------------------------------------------------------------------
Ext.define('DSS.infra_shapes.SplitLine', {
//------------------------------------------------------------------------------
	extend: 'Ext.Container',
	alias: 'widget.infra_split',
    alternateClassName: 'DSS.SplitinfraShapes',
    singleton: true,	
	...
	initComponent: function() {
		...
		Ext.applyIf(me, {
			items: [{
				...
				html: 'infra Shapes <i class="fas fa-cut fa-fw accent-text text-drp-50"></i>',
				height: 35
			},{
				xtype: 'container',
				...
				items: [{
					...
					xtype: 'component',
					cls: 'information light-text text-drp-20',
					html: 'Click a single infra to begin',
				},{
					xtype: 'button',
					cls: 'button-text-pad',
