...
class QgsExifTools(sip.wrapper):
    ...
    @staticmethod
    def geoTagImage(imagePath: str, location: _core.QgsPointXY, details: 'QgsExifTools.GeoTagDetails' = ...) -> bool: ...
    @staticmethod
    def hasGeoTag(imagePath: str) -> bool: ...
    @staticmethod
    def getGeoTag(imagePath: str) -> typing.Tuple[_core.QgsPoint, bool]: ...
